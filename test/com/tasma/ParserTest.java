...
public class ParserTest {
    ...
    public void setUp() {
        ...
        comparator = DateTimeComparator.getInstance(DateTimeFieldType
                .minuteOfHour());
    }
    ...
    public void testInvalidTime() {
        parsedTask = caller
                .parse("sign up for stan chart marathon 22-05-15 at -2pm");
    ...
    public void testFromTo() {
        parsedTask = caller
                .parse("meeting with boss 22.05.15 from 2pm to 3:30pm");
    ...
    public void testDateSwap() {
        parsedTask = caller
                .parse("meet classmates for lunch next week 4pm to 3pm");
