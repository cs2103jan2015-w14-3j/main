...
public class Palette {
	...
	public static final Color MESSAGE_WARNING = new Color(217, 217, 61);
	public static final Color MESSAGE_DANGER = new Color(217, 71, 61);
	public static final Color MESSAGE_INFO = THEME_BLUE;
	public static final Color MESSAGE_GRAYED = new Color(60, 60, 60);
